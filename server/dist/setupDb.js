...
async function main() {
    ...
    try {
        ...
        if (adminCheck.rows.length === 0) {
            ...
            await client.query(`INSERT INTO public.profiles (id, full_name, phone, email, password_hash, role)
         VALUES ($1, $2, $3, $4, $5, $6)`, [adminId, 'Admin User', '1234567890', adminEmail, passwordHash, 'admin']);
